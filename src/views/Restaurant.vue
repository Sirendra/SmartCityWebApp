            ...
            <div class="row py-lg-4">
              <div class="col-lg-6 col-md-8 mx-auto">
                ...
                <tbody>
                    ...
                    <tr v-for="item in searchRestaurant" v-bind:key="item.id">
...
export default {
  ...
  created () {
    db.collection("restaurant").orderBy("restname","asc").get().then((querySnapshot) => {
  ...
  computed:{
    searchRestaurant: function(){
      return this.rest.filter((rest)=>{
        return rest.restname.match(this.search)
      })
    }
   },
   mounted() {
