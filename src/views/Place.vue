        ...
        <div class="py-5 text-center " style="background-color:lightblue;">
            <div class="row py-lg-4">
              <div class="col-lg-6 col-md-8 mx-auto">
                <h1 class="fw-light">Attractions</h1>  
              </div>
            </div>
            </div >
                  <div class="row">
                ...
                <tbody>
                    ...
                    <tr v-for="item in filterplaces" v-bind:key="item.id">
                      <div class="col">
                        <div class="card shadow-sm" style="max-width: 325px;">   
                          <!-- <a class="lightbox" v-bind:href="user_alias.imageUrl"><img v-bind:src="user_alias.imageUrl"  class="card-img-top" ></a> -->
                         <a class="lightbox"><img v-bind:src="item.attimageUrl" alt="NO Image" class="card-img-top" style="width: 100%; max-width: 400px; height:200px;"></a>
...
export default {
  ...
  created () {
    db.collection("attractions").orderBy("attname","asc").get().then((querySnapshot) => {
  ...
  computed:{
    filterplaces: function(){
      return this.places.filter((att)=>{
        return att.attname.match(this.search)
      })
    }
  },
  mounted() {
